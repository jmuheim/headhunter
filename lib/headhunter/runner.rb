...
module Headhunter
  class Runner
    ...
    def clean_up!
      puts "Headhunter is removing precompiled assets...".yellow
      remove_assets!
      puts " done!".yellow
    end
    ...
    def precompile_assets!
      puts "Headhunter is removing eventually existing assets...".yellow
      ...
      puts "Headhunter is precompiling assets...".yellow
